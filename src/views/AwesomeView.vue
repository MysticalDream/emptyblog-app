  ...
  <div>
    ...
    >
      <defs>
        ...
        >
          <image
            xlink:href="../assets/awesome/pattern_141.gif"
            width="100"
            height="100"
            preserveAspectRatio="none"
          ></image>
        ...
        <g id="shape-butterfly-1">
          <path
            ...
            fill=""
            clip-rule="evenodd"
            d="M8.65,2.85c0.934-0.2,2.15-0.333,3.65-0.4c1.534-0.1,2.667-0.083,3.4,0.05
    ...
    <section class="scene3d">
            ...
            <var class="translate3d">
              <var class="translate3d-1">
                <figure class="butterfly">
                  <svg
                    class="wing left icon shape-codepen"
                    viewBox="0 0 50 100"
                  >
                    <use class="left" xlink:href="#shape-butterfly-1"></use>
                  </svg>
                  <svg
                    class="wing right icon shape-codepen"
                    viewBox="0 0 50 100"
                  >
                    <use class="left" xlink:href="#shape-butterfly-1"></use>
                  </svg>
      ...
      <div
        class="butterfly_container scale_half"
        style="
          margin-top: -10px;
          margin-left: 50px;
          -webkit-animation-duration: 5s;
      ...
      <div
        class="butterfly_container scale_third"
        style="
          margin-top: 150px;
          -webkit-animation-duration: 20s;
          -moz-animation-duration: 20s;
...
.skybox.cube var.scale {
  ...
  -o-transform-style: preserve-3d;
  transform-style: preserve-3d;
  -webkit-transform: rotate3d(0, 0, 1, 15deg) translate3d(0, 100px, 0)
    scale3d(4, 6, 4);
  -moz-transform: rotate3d(0, 0, 1, 15deg) translate3d(0, 100px, 0)
    scale3d(4, 6, 4);
  -ms-transform: rotate3d(0, 0, 1, 15deg) translate3d(0, 100px, 0)
    scale3d(4, 6, 4);
  -o-transform: rotate3d(0, 0, 1, 15deg) translate3d(0, 100px, 0)
    scale3d(4, 6, 4);
...
.skybox.cube .face.front {
  ...
  background-image: url("../assets/awesome/clouds_front.jpg");
}
...
.skybox.cube .face.back {
  ...
  background-image: url("../assets/awesome/clouds_back.jpg");
}
...
.skybox.cube .face.right {
  ...
  background-image: url("../assets/awesome/clouds_right.jpg");
}
...
.skybox.cube .face.left {
  ...
  -o-transform: rotateY(90deg) translateZ(-256px);
  transform: rotateY(90deg) translateZ(-256px);
  background-image: url("../assets/awesome/clouds_left.jpg");
}
...
.skybox.cube .face.top {
  ...
  background-image: url("../assets/awesome/clouds_top.jpg");
}
...
.skybox.cube .face.bottom {
  ...
  -o-transform: rotateX(90deg) translateZ(-256px);
  transform: rotateX(90deg) translateZ(-256px);
  background-image: url("../assets/awesome/hazy_lake_top.jpg");
  background: none;
}
